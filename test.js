const { envFromPathToJson, envFromStringToJson, jsonFromPathToEnv } = require("./index.js");

console.log('// ENV2JSON: location here is the part from the app root.')

const { jsonEnv: env1, location: loc1 } = envFromPathToJson('./examples/.env-sample'); 
...
const { jsonEnv: env3, location: loc3 } = jsonFromPathToEnv('examples/env-sample.json');
